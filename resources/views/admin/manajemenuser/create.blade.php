...
<head>
    ...
    <title>Tambah User - Desa Sidorejo</title>
...
<body class="antialiased bg-gray-100">
    <header class="sticky top-0 z-50 text-white shadow-lg bg-mainColor">
        <div class="container flex items-center justify-between px-4 py-3 mx-auto">
            ...
            <nav class="hidden space-x-6 sm:flex sm:items-center">
                ...
                <a href="/" class="text-sm font-bold text-white hover:underline">Tambah User</a>
            </nav>
        </div>
    </header>
    ...
    <main class="container px-6 py-20 mx-auto">
        <div class="items-center">
            ...
            <h2 class="mb-8 text-2xl font-bold text-center">Tambah User</h2>
            ...
            <div class="max-w-2xl p-6 mx-auto mb-8 bg-white border border-gray-200 rounded-lg shadow-sm drop-shadow">
                ...
                <form action="{{ route('daftaruser.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nama" name="nama" value="{{ old('nama') }}" class="block w-full px-4 py-2 mt-1 border border-gray-300 rounded-lg shadow-sm focus:ring-mainColor focus:border-mainColor" required>
                            </div>

                            <!-- No Telp -->
                            <div class="mb-4">
                                <label for="no_telepon" class="block text-sm font-medium text-gray-700">No Telepon</label>
                                <input type="text" id="no_telepon" name="no_telepon" value="{{ old('no_telepon') }}" class="block w-full px-4 py-2 mt-1 border border-gray-300 rounded-lg shadow-sm focus:ring-mainColor focus:border-mainColor" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="email" rows="3" value="{{ old('email') }}" class="block w-full px-4 py-2 mt-1 border border-gray-300 rounded-lg shadow-sm focus:ring-mainColor focus:border-mainColor" required>
                            </div>

                            <!-- Password -->
                            <div class="mb-4">
                                <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                                <input type="text" name="password" rows="3" value="{{ old('password') }}" class="block w-full px-4 py-2 mt-1 border border-gray-300 rounded-lg shadow-sm focus:ring-mainColor focus:border-mainColor" required>
                            </div>
                        </div>
