            ...
            <div class="grid grid-cols-2 gap-6 py-3">
                <div class="flex items-center p-4 mb-8 ml-8 bg-white border border-gray-200 rounded-lg sm:px-6 lg:px-8 drop-shadow">
                    ...
                    <div class="flex flex-col space-y-1 text-center">
                        <p id="totalKelahiranAdm" class="text-2xl font-bold text-gray-800">{{ $totalKelahiranAdm }}</p>
                        <span class="text-xs font-light">Total Permohonan Surat Kelahiran</span>
                    </div>
                </div>
                <div class="flex items-center p-4 mb-8 mr-8 bg-white border border-gray-200 rounded-lg drop-shadow sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col space-y-1 text-center">
                        <p id="totalKematianAdm" class="text-2xl font-bold text-gray-800">{{ $totalKematianAdm }}</p>
                        <span class="text-xs font-light">Total Permohonan Surat Kematian</span>
                    </div>
                </div>
            </div>

            {{-- <div class="p-6 mb-8 ml-8 mr-8 bg-white border border-gray-200 rounded-lg drop-shadow">
                <!-- Grafik Statistik -->
                <div id="charts-container" class="grid grid-cols-2 gap-8 mt-8">
                    <!-- Kelahiran Chart -->
                    <div id="kelahiran-chart-container" style="display: none;">
                        <canvas id="kelahiranChart" class="w-full h-64"></canvas>
                    </div>
                    <!-- Kematian Chart -->
                    <div id="kematian-chart-container" style="display: none;">
                        <canvas id="kematianChart" class="w-full h-64"></canvas>
                    </div>
                </div>
            </div> --}}
        </div>
