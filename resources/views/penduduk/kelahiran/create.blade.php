    ...
    <main class="container px-6 py-20 mx-auto">
        <div class="items-center">
            ...
            <div class="max-w-2xl p-6 mx-auto mb-8 bg-white border border-gray-200 rounded-lg shadow-sm drop-shadow">
                ...
                <form action="{{ route('kelahiranpenduduk.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        @if (!auth()->user()->hasRole('penduduk'))
                            <div class="mb-4">
                                ...
                                <input type="text" name="nomor_surat" id="nomor_surat" class="block px-2 py-1 mt-1 border border-gray-300 rounded-lg shadow-sm w-28 focus:ring-mainColor focus:border-mainColor" value="{{ old('nomor_surat') }}">
                                @error('nomor_surat')
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <!-- Field untuk Foto Akta Lahir -->
                            <div class="mb-4">
                                <label for="foto_akta_lahir" class="block text-sm font-medium text-gray-700">Foto Akta Lahir</label>
                                <input type="file" id="foto_akta_lahir" name="foto_akta_lahir"
                                       class="block w-full px-4 py-2 mt-1 text-xs border border-gray-300 rounded-lg shadow-sm focus:ring-mainColor focus:border-mainColor"
                                       accept=".jpg,.jpeg,.png,.pdf" required>
                                @error('foto_akta_lahir')
                                    <span class="text-sm text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-6 space-x-4">
                            ...
                            <a href="{{ route('kelahiranpenduduk.index') }}" class="px-6 py-2 text-sm font-semibold text-black bg-gray-300 rounded-lg shadow-md hover:bg-gray-400 focus:outline-none">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
