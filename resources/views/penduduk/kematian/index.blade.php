                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-center whitespace-nowrap">
                                    <div class="flex items-center justify-center space-x-2" aria-label="Basic example">
                                        <a href="{{ route('kematianpenduduk.edit', $item->id) }}" type="button" class="items-center justify-center px-4 py-2 text-xs text-white bg-gray-500 rounded-lg hover:bg-gray-600">
                                        ...
                                        <a href="{{ route('kematianpenduduk.downloadPdf', $item->id) }}" class="px-4 py-2 text-xs text-white bg-blue-500 rounded-lg hover:bg-blue-600">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
